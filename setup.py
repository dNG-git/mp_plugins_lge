...
with TemporaryDirectory(dir = ".") as build_directory:
    parameters = { "mpPluginsLgeVersion": get_version() }
    ...
    setup(name = "mp_plugins_lge",
          version = get_version(),
          description = "A device centric multimedia solution",
          long_description = """"mp_plugins_lge" contains plugins for "LG Electronics, Inc." devices.""",
          author = "direct Netware Group et al.",
          author_email = "web@direct-netware.de",
          license = "GPLv2+",
          url = "https://www.direct-netware.de/redirect?mp;plugins_lge",
